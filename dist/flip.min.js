!function (){
  ...
  function d(a, b, c, d){
    ...
    if (c) {
      for (var g in c)e = Object.getOwnPropertyDescriptor(c, g), e ? Object.defineProperty(f, g, e) : f[g] = c[g];
    }
  ...
  function e(a){
    ...
    if (a && a.length) {
      for (var b = 0, c = a.length; c > b; b++)this[b] = a[b]
    }
  }
  ...
  function h(a, b){
    for (var c, d = 0, e = a.length, f = j(b); e > d; d++)if (f(c = a[d])) {
      return c;
    }
    return void 0
  }
  ...
  function l(a, b, c, d, e){
    var f, g, h = k(b);
    if (void 0 === c && (c = !0), d) {
      for (f = 0, g = a[0]; g; g = a[++f])if (h(g) == c) {
        return e ? f : g
      }
    } else {
      for (f = 0, g = a[0]; g; g = a[++f])if (h(g) === c) {
  ...
  function t(a, b, c, d){
    if (w(a)) {
      if (void 0 == c && (c = a), a instanceof Array) {
        a.forEach(b, c);
      } else {
        for (var e = 0, f = Object.getOwnPropertyNames(a), g = f[0]; g; g = f[++e])b.apply(c, [a[g], g, d]);
      }
    }
    return a
  }
  ...
  function E(a){
    return this instanceof E ? (this.name = a, this.timeline = new na(this), this._updateObjs = [], this._finalizeObjs = [], void(this._global = null)) : new E(a)
  }

  function F(a){
    return this instanceof F ? (c(this, b(a, {
      selector: "",
      fillMode: va.REMOVE,
      clock: a.clock || new P(a)
    })), this._cssHandlerMap = {}, this._matHandlerMap = {}, this._cachedMat = {}, this._immutable = {}, this._variable = {}, this._param = {}, this.current = {}, this.use(a), void this.init()) : new F(a)
  }

  function G(a, b){
    var c, d;
    if (!(c = a._task)) {
      if (b = b || {}, c = b.task || (d = b.global || oa.global).getTask(b.taskName || a._ltName) || d.defaultTask, !(c instanceof E)) {
  ...
  function M(a){
    for (var b, c = 1, d = arguments[1]; d; d = arguments[++c])Ca.forEach(function (c){
      v(b = d[c]) ? a[c](b) : w(b) && (O(b) ? t(b, function (b, d){
        a[c](d, b)
      }) : a[c](b))
  ...
  function P(a){
    return this instanceof P ? void c(this, b(a, {
      duration: 1,
      ease: P.EASE.linear,
      infinite: !1,
      iteration: 1,
  ...
  function R(a, b){
    function c(){
      return a.i > 1 || a.infinite ? (a.i--, S(a, f), Q(a, Ea, b), void 0) : (a.i = 0, a._holdTime = f, a._status = Na, Q(a, Ia, b), R(a, b) || !0)
    }

    var d, e = b.timeline, f = e.now;
    switch (a._status) {
      case Qa:
        return a._initTime = f, Q(a, Da, b), a._status = Ma, R(a, b) || !0;
      case Ma:
        return f >= a._initTime + a.delay * e.ticksPerSecond ? (a._status = La, a._activeTime = a._startTime = f, Q(a, Ga, b), R(a, b) || !0) : !1;
      case La:
        var g = (f - a._activeTime) / e.ticksPerSecond, h = a.d ? g / a.duration : 1 - g / a.duration;
        return d = a.t, d === h ? !1 : (h > 1 ? a.t = 1 : 0 > h ? a.t = 0 : a.t = h, a.value = a.ease(a.t), Q(a, qa, b), a.silent || b.task.invalid(), (h > 1 || 0 > h) && (a._status = Pa, R(a, b)), !0);
      case Pa:
        if (d = a.t, !(d >= 1)) {
          if (a.autoReverse) {
            return c(a.d = 1);
        ...
        return a.autoReverse ? (a.d = 0, S(a, f), Q(a, Fa, b), !1) : c();
      case Na:
  ...
  function Y(a){
    ...
    a.emit(pa, [b]), Z(a, b), aa(a, b), a.emit(ra, [b])
  }
  ...
  function aa(a, b){
    if (a._invalid || b.forceRender) {
      ...
      var c = a._styleElement = _(a._styleElement), d = c.sheet;
  ...
  function da(a, b){
    var c = a.clock;
    return b.animation = a, T(c, b) && (a.invalid(), ga(a), a.emit(qa, b)), c.finished && (a._finished = !0, ea(a, b)), b.animatetion = null, !0
  }
  ...
  function fa(a, b){
    var c = b.styleStack;
    b.animation = a, c.push.apply(c, ha(a)), ia(a, b.transformMap), a.emit(xa, b), a._finished && a.emit(ya, b), b.animation = null
  }
    ...
    return t(a._cssHandlerMap, function (f, g){
      d.push({
        selector: g.replace(/&/g, e), rules: f.map(function (d){
          return ka(d.cb, d.proxy, a, c, b).$toCachedCssString()
        })
      })
    }), d
  }
  ...
  function la(a){
    return this instanceof la ? (a = b(a, { defaultTaskName: "default" }), this._tasks = {}, this._defaultTaskName = a.defaultTaskName, this._invalid = !0, this._persistIndies = [], this._persistElement = U({
      tagName: "style",
      attributes: { "data-flip": "frame" }
    }), void(this._styleElement = U({ tagName: "style", attributes: { "data-flip": "persist" } }))) : new la(a)
  }
  ...
  function ma(b, c, d, e){
    ...
    return F.prototype[c].apply(h, [d, e]), a(function (){
      var a = ha(h).map(C).join("");
      g = b.immediate(a)
    }), f
  }
  ...
  e.remove = i, e.add = f, e.first = h, e.findBy = l, e.sort = g, d(e, Array, {
    ...
    update: y, invalid: function (){
      ...
      return "update" == b ? f(this._updateObjs, a) : ((a instanceof P || a instanceof D) && f(this._updateObjs, a) && (a._task = this), void this.invalid())
    }, remove: function (a){
      (a._task == this || this._updateObjs.indexOf(a) > -1) && (a._task = null, this.toFinalize(a), this.invalid())
    }
  });
  var va = F.FILL_MODE = { REMOVE: "remove", SNAPSHOT: "snapshot", KEEP: "keep" };
  d(F, D, {
    get percent(){
      ...
      return this._promise || (this._promise = I(this))
    }, get finished(){
      ...
      return w(a) ? J(a, this[b ? "_immutable" : "_variable"]) : x(a) && (this[c ? "_immutable" : "_variable"][a] = b), this
    }, transform: function (a, b){
      var c = this._matHandlerMap;
      return t(N(arguments), function (a, b){
        var d;
        if (a instanceof V) {
          d = function (b){
            return b.concat(a)
  ...
  a.animate = K, a.register = function (){
    function a(c){
      ...
      return e = c.beforeCallBase || b, f = function (a){
        ...
        var b = J(a, J(c, {}));
        e.call(this, b, a), F.call(this, b), (c.afterInit || y).call(this, b, a)
      }, g && (a[g] = f), d(f, F.prototype, {
  ...
  d(P, o, {
    get controller(){
      ...
      this._status !== Ka && (this._lastStatus = this._status, this._status = Ka, Q(this, Aa))
    }, resume: function (){
      this._status == Ka && (this._status = this._lastStatus, Q(this, Ba))
    }, cancel: function (){
      ...
      this.finished ? this.finalize() : T(this, a)
    }
  }), a.EASE = P.EASE = function (){
    var a = {
      linear: function (a){
        return a
      }, zeroStep: function (a){
    ...
    a.$$ = b, a.$ = c, a.ele = U, "complete" == document.readyState && setTimeout(d, 0), document.addEventListener("DOMContentLoaded", d)
  }(a);
  ...
  a.Mat3 = V, V.prototype = {
    print: function (){
      ...
      var b = a instanceof V ? a.elements : a;
      return X(this, b)
    }, axonProject: function (a, b){
      a = a || 0, b = b || 0;
      var c = Ta(a), d = Sa(a), e = Ta(b), f = Sa(b);
      return X(this, [e, d * f, 0, 0, c, 0, f, -e * d, 0], 1)
    }, obliqueProject: function (a, b){
      b = b || 0, a = a || 0;
      var c = 1 / Ua(a), d = Sa(b) * c, e = Ta(b) * c;
      return X(this, [1, 0, 0, 0, 1, 0, e, d, 0], 1)
    }, toString: function (){
      return "matrix(" + Va(this.elements).join(",") + ")"
    }, applyContext2D: function (a){
      return a.transform.apply(a, Va(this.elements)), this
    }, clone: function (){
      return new V(this.elements)
    }, scale: function (a, b){
      return X(this, [W(a, 1), 0, 0, 0, W(b, 1), 0, 0, 0, 1])
    }, skew: function (a){
      return X(this, [1, Ua(a), 0, Ua(a || 0), 1, 0, 0, 0, 1])
    }, transform: function (a, b, c, d, e, f){
      return X(this, [a, c, 0, b, d, 0, e || 0, f || 0, 1])
    }, translate: function (a, b, c){
      return X(this, [1, 0, 0, 0, 1, 0, a || 0, b || 0, W(c, 1)])
    }, flip: function (a, b, c){
      var d = Sa(a), e = Ta(a);
      return c = c || .6, X(this, b ? [1, 0, 0, -d * c, e, 0, 0, 0, 1] : [e, d * c, 0, 0, 1, 0, 0, 0, 1])
    }, rotate: function (a){
      return this.rotateZ(a)
    }, rotateX: function (a){
      var b = Sa(a), c = Ta(a);
      return X(this, [1, 0, 0, 0, c, b, 0, -b, c])
    }, rotateY: function (a){
      var b = Sa(a), c = Ta(a);
      return X(this, [c, 0, -b, 0, 1, 0, b, 0, c])
    }, rotateZ: function (a){
      var b = Sa(a), c = Ta(a);
      return X(this, [c, b, 0, -b, c, 0, 0, 0, 1])
    }
  }, function (a){
    function b(a){
      m ? a() : setTimeout(a, 0)
    ...
    function i(b){
      ...
      if (n) {
        if (b instanceof F) {
          return b._finished ? b : b.promise;
        }
        if ("object" == (c = typeof b)) {
          return j(b) ? b : b instanceof Array ? b.map(i) : a.animate(b).promise;
        }
  ...
  }(a), a.RenderGlobal = la, d(la, a.util.Object, {
    get defaultTask(){
      ...
      if (a instanceof E) {
        ...
        if ((c = this._tasks).hasOwnProperty(b)) {
          throw Error("contains same name task");
        }
        if (c[b] = a) {
          return a._global = this, a.timeline.start(), this.invalid()
        }
      } else if (w(a)) {
        return this.defaultTask.add(a);
      }
      return !1
      ...
      Y(this), window.requestAnimationFrame(this.loop.bind(this), a || window.document.body)
    }, createRenderState: function (){
      return { global: this, task: null, styleStack: [], forceRender: this._foreceRender, transformMap: {} }
    }, css: function (a, b){
      return ma(this, "css", a, b)
    }, transform: function (a, b){
      return ma(this, "transform", a, b)
    }
  }), oa.global = new la, d(na, a.util.Object, {
